    ...
    def _handle_game_over(self, cast):
        ...
        if self._is_game_over:
            if self._dead_player == "cycle_1":
                ...
                cycle_2.set_text("X")
                cycle_1 = cast.get_first_actor("cycle_1")
                segements_1 = cycle_1.get_segments()

                # for segment in segements_1:
                    # segements_1.set_color(constants.RED)
            ...
            message = Actor()
            message.set_text(f"Game Over! {self._dead_player} is the winner!")
